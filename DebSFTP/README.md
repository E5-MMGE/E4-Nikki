...
</br>![Debian Name](/DebFTP/Img/Deb_Install-5.png?raw=true "Debian Name")
...
</br>![Debian Username](/DebFTP/Img/Deb_Install-8.png?raw=true "Debian Username")
...
</br>![Debian Username 2](/DebFTP/Img/Deb_Install-9.png?raw=true "Debian Username 2")
...
</br>![Debian Partition](/DebFTP/Img/Deb_Install-11.png?raw=true "Debian Partition")
...
</br>![Debian WriteDisk](/DebFTP/Img/Deb_Install-14.png?raw=true "Debian WriteDisk")
20. Choisissez la phrase de chiffrement pour le disque et continuez, j'utilise ici mon programme une nouvelle fois
</br>![Debian Encryption](/DebFTP/Img/Deb_Install-15.png?raw=true "Debian Encryption")

21. Il est maintenant demandé la taille de la partition, laissez la taille par défaut et continuez
</br>![Debian Partition Size](/DebFTP/Img/Deb_Install-16.png?raw=true "Debian Partition Size")

22. Choisissez "Continuer" pour valider les modifications sur le disque
</br>![Debian Partition Write](/DebFTP/Img/Deb_Install-17.png?raw=true "Debian Partition Write")

23. Choisissez "Oui" pour confirmer les écrire
</br>![Debian Partition Write Confirm](/DebFTP/Img/Deb_Install-18.png?raw=true "Debian Partition Write Confirm")
...
</br>![Debian Finish 2](/DebFTP/Img/Deb_Install-28.png?raw=true "Debian Finish 2")
...
</br>![Debian Uncrypted](/DebFTP/Img/Deb_Install-28.png?raw=true "Debian Uncrypted")
...
</br>![Debian Root](/DebFTP/Img/Deb_Launch-1.png?raw=true "Debian Root")
...
```
</br>![Debian Update](/DebFTP/Img/Deb_Launch-3.png?raw=true "Debian Update")
...
```
</br>![Debian Sudo](/DebFTP/Img/Deb_Launch-4.png?raw=true "Debian Sudo")

6. Déconnectez vous de la session root et reconnectez vous avec le compte utilisateur
</br>![Debian User](/DebFTP/Img/Deb_Launch-5.png?raw=true "Debian User")
</br>![Debian User 2](/DebFTP/Img/Deb_Launch-6.png?raw=true "Debian User 2")
...
```
</br>![Debian SFTP Install](/DebFTP/Img/Deb_sftp-1.png?raw=true "Debian SFTP Install")

3. Vérifiez que SFTP est bien démarré
```sh
sudo systemctl status sshd
```
</br>![Debian SFTP Status](/DebFTP/Img/Deb_sftp-2.png?raw=true "Debian SFTP Status")
...
</br>![Debian SFTP User](/DebFTP/Img/Deb_sftp-3.png?raw=true "Debian SFTP User")
...
```
</br>![Debian SFTP UFW](/DebFTP/Img/Deb_sftp-4.png?raw=true "Debian SFTP UFW")

3. Redémarrez SFTP
```sh
sudo systemctl restart sshd
```
</br>![Debian SFTP Restart](/DebFTP/Img/Deb_sftp-5.png?raw=true "Debian SFTP Restart")
...
```
</br>![Debian Fail2Ban Install](/DebFTP/Img/Deb_fail2ban-1.png?raw=true "Debian Fail2Ban Install")

4. Vérifiez que Fail2Ban est bien démarré
```sh
sudo systemctl status fail2ban
```
</br>![Debian Fail2Ban Status](/DebFTP/Img/Deb_fail2ban-2.png?raw=true "Debian Fail2Ban Status")
...
maxretry = 3
```
</br>![Debian Fail2Ban Config 3](/DebFTP/Img/Deb_fail2ban-3.png?raw=true "Debian Fail2Ban Config 3")

3. Redémarrez Fail2Ban
```sh
sudo systemctl restart fail2ban
```
</br>![Debian Fail2Ban Restart](/DebFTP/Img/Deb_fail2ban-4.png?raw=true "Debian Fail2Ban Restart")
...
ip a
```
</br>![Debian IP](/DebFTP/Img/Deb_Use-1.png?raw=true "Debian IP")
...
</br>![FileZilla](/DebFTP/Img/Deb_Use-2.png?raw=true "FileZilla")
</br>![FileZilla](/DebFTP/Img/Deb_Use-3.png?raw=true "FileZilla")
