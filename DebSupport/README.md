<br/>
<p align="center">
  <h2 align="center">Mise en place Clé de support (Debian 11/12)</h2>
  <p align="center">
...
sudo ufw enable
```
</br>![UFW Terminal](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_RustServ-0.png?raw=true "UFW Terminal")
...
./install.sh
```
</br>![RustDesk Terminal](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_RustServ-1.png?raw=true "RustDesk Terminal")
...
</br>![RustDesk Terminal](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_RustServ-2.png?raw=true "RustDesk Terminal")
...
</br>![RustDesk Terminal](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_RustServ-3.png?raw=true "RustDesk Terminal")

5. Copiez la clé publique, nous en aurons besoin plus tard
</br>![RustDesk Terminal](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_RustServ-4.png?raw=true "RustDesk Terminal")
...
```
</br>![Tailscale Terminal](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Tailscale-0.png?raw=true "Tailscale Terminal")

7. Connectez vous à votre compte Tailscale en tapant la commande suivante dans un terminal (CTRL+T) :
```bash
sudo tailscale up
```
</br>![Tailscale Up](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Tailscale-1.png?raw=true "Tailscale Up")

2. Allez sur le site pour vous connecter, et connectez vous à votre compte Tailscale
</br>![Tailscale Site](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Tailscale-2.png?raw=true "Tailscale Site")

3. Cliquez sur "Connect" pour connecter le système à votre compte Tailscale
</br>![Tailscale Connect](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Tailscale-3.png?raw=true "Tailscale Connect")
...
</br>![Tailscale Disable Key](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_RustScale-4.png?raw=true "Tailscale Disable Key")
...
sudo tailscale ip -4
```
</br>![Tailscale Terminal](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_RustScale-5.png?raw=true "Tailscale Terminal")
...
</br>![VmWare](https://8e-couche.ovh/Portfolio/DebSupport/Img/VmWare-1.png?raw=true "VmWare")

4. Créez une nouvelle machine virtuelle et sélectionnez « Custom »
</br>![VmWare Create](https://8e-couche.ovh/Portfolio/DebSupport/Img/VmWare-2.png?raw=true "VmWare Create")

5. Faites next et encore next, puis sélectionnez « I will install the operating system later » et continuez
</br>![VmWare Create](https://8e-couche.ovh/Portfolio/DebSupport/Img/VmWare-3.png?raw=true "VmWare Create")
</br>![VmWare Create No OS](https://8e-couche.ovh/Portfolio/DebSupport/Img/VmWare-4.png?raw=true "VmWare Create No OS")

6. Sélectionnez « Linux » et cherchez « Debian 11.x 64-bit » avant de continuer
</br>![VmWare Create OS](https://8e-couche.ovh/Portfolio/DebSupport/Img/VmWare-5.png?raw=true "VmWare Create OS")
...
</br>![VmWare Create Name](https://8e-couche.ovh/Portfolio/DebSupport/Img/VmWare-6.png?raw=true "VmWare Create Name")
...
</br>![VmWare Create Cores](https://8e-couche.ovh/Portfolio/DebSupport/Img/VmWare-7.png?raw=true "VmWare Create Cores")
</br>![VmWare Create RAM](https://8e-couche.ovh/Portfolio/DebSupport/Img/VmWare-8.png?raw=true "VmWare Create RAM")

10. Laissez la carte réseau en NAT pour avoir un accès à internet lors de l’installation et continuez
</br>![VmWare Create Network](https://8e-couche.ovh/Portfolio/DebSupport/Img/VmWare-9.png?raw=true "VmWare Create Network")

11. Laissez le controller de disque tel quel et continuez, de même pour le type de disque
</br>![VmWare Create Disk](https://8e-couche.ovh/Portfolio/DebSupport/Img/VmWare-10.png?raw=true "VmWare Create Disk")
</br>![VmWare Create Disk 2](https://8e-couche.ovh/Portfolio/DebSupport/Img/VmWare-11.png?raw=true "VmWare Create Disk 2")

12. Continuez, sélectionnez « Use a physical disk »
</br>![VmWare Create Disk](https://8e-couche.ovh/Portfolio/DebSupport/Img/VmWare-12.png?raw=true "VmWare Create Disk")
...
</br>![VmWare Create Disk USB](https://8e-couche.ovh/Portfolio/DebSupport/Img/VmWare-13.png?raw=true "VmWare Create Disk USB")
</br>![VmWare Create Disk USB 2](https://8e-couche.ovh/Portfolio/DebSupport/Img/VmWare-14.png?raw=true "VmWare Create Disk USB 2")

14. Continuez jusqu'à la fin de la création de la machine virtuelle
</br>![VmWare Create Options](https://8e-couche.ovh/Portfolio/DebSupport/Img/VmWare-15.png?raw=true "VmWare Create Options")
</br>![VmWare Create Options 2](https://8e-couche.ovh/Portfolio/DebSupport/Img/VmWare-16.png?raw=true "VmWare Create Options 2")
...
</br>![VmWare Settings](https://8e-couche.ovh/Portfolio/DebSupport/Img/VmWare-17.png?raw=true "VmWare Settings")

16. Sélectionnez "USB Compatibility" et sélectionnez "USB 3.1" dans la liste déroulante
</br>![VmWare Settings USB](https://8e-couche.ovh/Portfolio/DebSupport/Img/VmWare-18.png?raw=true "VmWare Settings USB")

17. Allez dans « CD/DVD (IDE) », sélectionnez « Use ISO image file : » et mettez l’Iso de Debian 11
</br>![VmWare Settings ISO](https://8e-couche.ovh/Portfolio/DebSupport/Img/VmWare-19.png?raw=true "VmWare Settings ISO")
...
</br>![VmWare Settings ISO](https://8e-couche.ovh/Portfolio/DebSupport/Img/VmWare-20.png?raw=true "VmWare Settings ISO")
...
</br>![Debian Name](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Install-5.png?raw=true "Debian Name")
...
</br>![Debian Username](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Install-8.png?raw=true "Debian Username")
...
</br>![Debian Username 2](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Install-9.png?raw=true "Debian Username 2")
...
</br>![Debian Partition](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Install-11.png?raw=true "Debian Partition")
...
</br>![Debian Partition Write](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Install-17.png?raw=true "Debian Partition Write")

18. Choisissez « Oui » pour confirmer les écrire
</br>![Debian Partition Write Confirm](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Install-18.png?raw=true "Debian Partition Write Confirm")
...
</br>![Debian Finish 2](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Install-28.png?raw=true "Debian Finish 2")
...
</br>![Debian Root](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Install-28.png?raw=true "Debian Root")
...
```
</br>![Debian Update](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Launch-3.png?raw=true "Debian Update")
...
```
</br>![Debian Sudo](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Launch-4.png?raw=true "Debian Sudo")

6. Déconnectez vous de la session root et reconnectez vous avec le compte utilisateur
</br>![Debian User](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Launch-5.png?raw=true "Debian User")
</br>![Debian User 2](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Launch-6.png?raw=true "Debian User 2")
...
</br>![Tailscale Disable Key](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Tailscale-4.png?raw=true "Tailscale Disable Key")
...
sudo systemctl enable tailscaled
```
</br>![Tailscale Terminal](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Tailscale-5.png?raw=true "Tailscale Terminal")
...
</br>![RustDesk Github](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_RustDesk-1.png?raw=true "RustDesk Github")
...
</br>![RustDesk Terminal Dependancies](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_RustDesk-2.png?raw=true "RustDesk Terminal Dependancies")
</br>![RustDesk Terminal Install](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_RustDesk-3.png?raw=true "RustDesk Terminal Install")

3. Lancez ensuite RustDesk en tapant la commande suivante dans un terminal (CTRL+T) :
```bash
rustdesk
```
</br>![RustDesk Launch](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_RustDesk-4.png?raw=true "RustDesk Launch")

##### Configuration de RustDesk

1. Une fois RustDesk lancé, cliquez sur les trois tirets en haut à droite
</br>![RustDesk Menu](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_RustDesk-5.png?raw=true "RustDesk Menu")

2. Allez dans "Sécurité" et "débloquez" les configurations de sécurité
</br>![RustDesk Security](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_RustDesk-6.png?raw=true "RustDesk Security")

3. Changez le mot de passe pour un mot de passe permanent et définissez-le
</br>![RustDesk Password](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_RustDesk-7.png?raw=true "RustDesk Password")

4. Allez dans "Réseau" et "débloquez" les configurations de réseau
</br>![RustDesk Network](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_RustDesk-8.png?raw=true "RustDesk Network")
...
</br>![RustDesk Network](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_RustDesk-9.png?raw=true "RustDesk Network")

6. Revenez dans la page d'accueil et récupérez l'ID RustDesk du Debian
</br>![RustDesk ID](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_RustDesk-10.png?raw=true "RustDesk ID")
...
```
</br>![Chntpw Terminal](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Chntpw-1.png?raw=true "Chntpw Terminal")

2. Vérifiez que l'installation s'est bien déroulée en tapant la commande suivante :
```bash
sudo chntpw -h
```
</br>![Chntpw Terminal](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Chntpw-2.png?raw=true "Chntpw Terminal")
...
```
</br>![Gparted Terminal](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Gparted-1.png?raw=true "Gparted Terminal")
...
```
</br>![Memtest86+ Terminal](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Memtest86+-1.png?raw=true "Memtest86+ Terminal")
...
```
</br>![BleachBit Terminal](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_BleachBit-1.png?raw=true "BleachBit Terminal")

2. Vérifiez que l'installation s'est bien déroulée en tapant la commande suivante :
```bash
sudo bleachbit -h
```
</br>![BleachBit Terminal](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_BleachBit-2.png?raw=true "BleachBit Terminal")
...
sudo bleachbit
```
</br>![BleachBit Menu](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_BleachBit-2.png?raw=true "BleachBit Menu")

2. Fermez la pop-up et cochez toutes les cases excepté "Free disk space" et "Memory" puis cliquez sur "Supprimer"
</br>![BleachBit Menu](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_BleachBit-3.png?raw=true "BleachBit Menu")
</br>![BleachBit Menu](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_BleachBit-4.png?raw=true "BleachBit Menu")
</br>![BleachBit Menu](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_BleachBit-5.png?raw=true "BleachBit Menu")
...
</br>![Gparted Mate](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Gparted-2.png?raw=true "Gparted Mate")
</br>![Gparted Menu](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Gparted-3.png?raw=true "Gparted Menu")
</br>![Gparted Where](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Gparted-4.png?raw=true "Gparted Where")
...
```
</br>![Gparted Mount](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Gparted-5.png?raw=true "Gparted Mount")
...
chntpw -l SAM
```
</br>![Chntpw Use](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Chntpw-3.png?raw=true "Chntpw Use")
...
</br>![Chntpw Clear](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Chntpw-4.png?raw=true "Chntpw Clear")
</br>![Chntpw Save](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Chntpw-5.png?raw=true "Chntpw Save")
- memtest86+
</br>Lors d'un démarrage, avant que Debian se lance, sélectionnez "Memory test (memtest86+)" dans GRUB
</br>![memtest Launch](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Memtest86+-2.png?raw=true "memtest Launch")
...
</br>![memtest Use](https://8e-couche.ovh/Portfolio/DebSupport/Img/Deb_Memtest86+-3.png?raw=true "memtest Use")
